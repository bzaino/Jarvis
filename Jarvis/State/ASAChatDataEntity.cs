...
{
    public class ASAChatDataEntity : IAddress
    {
        ...
        internal ASAChatDataEntity() { Timestamp = DateTimeOffset.UtcNow; }
        internal ASAChatDataEntity(BotStoreType botStoreType, string botId, string channelId, string conversationId, string userId, object data)
        {
        ...
        internal static async Task<ASAChatDataEntity> GetASAChatDataEntity(IAddress key, BotStoreType botStoreType, ASAChatDataContext context)
        {
            ASAChatDataEntity entity = null;
